...
public class XafSoftDeleteWindowsFormsApplication : WinApplication {
    public XafSoftDeleteWindowsFormsApplication() {
    ...
    private void XafSoftDeleteWindowsFormsApplication_DatabaseVersionMismatch(object sender, DevExpress.ExpressApp.DatabaseVersionMismatchEventArgs e) {
#if EASYTEST
        e.Updater.Update();
        e.Handled = true;
#else
